import { ISetRepoMirrorService } from '@gits/core'
...
export class SetRepoMirrorCommand implements IRepoMirrorSubcommand {
  constructor(
    @Inject(ISetRepoMirrorService) private readonly service: ISetRepoMirrorService,
    ...
    cli.command(
      ...
      Cli.command({
        ...
        run: async (rawContext) => {
          ...
          return this.output.runRepoMirror(context, 'repo-mirrors set', async (signal) =>
