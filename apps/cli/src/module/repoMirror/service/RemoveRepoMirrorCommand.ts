...
const removeOptions = z
  .object({
    ...
    force: z
      .boolean()
      .default(false)
      .describe('Bypass dependent-repository protection'),
    jobs: z
      .number()
      .int()
      .min(1)
    ...
    purge: z
      .boolean()
      .default(false)
      .describe('Delete immediately instead of moving to trash'),
    yes: z
      .boolean()
      .default(false)
...
export class RemoveRepoMirrorCommand implements IRepoMirrorSubcommand {
  constructor(
    ...
    private readonly service: IRemoveRepoMirrorService,
