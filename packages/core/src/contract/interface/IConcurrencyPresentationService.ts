...
import type { ConcurrentPresentation, ConcurrentRunPresentation } from '../types/index'
...
export const IConcurrencyPresentationService: IdentifierDecorator<IConcurrencyPresentationService> =
  createIdentifier<IConcurrencyPresentationService>('core.concurrencyPresentationService')
